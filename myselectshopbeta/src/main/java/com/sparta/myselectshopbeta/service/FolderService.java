...
import com.sparta.myselectshopbeta.jwt.JwtUtil;
import com.sparta.myselectshopbeta.repository.FolderRepository;
...
public class FolderService {
    ...
    public List<Folder> addFolders(List<String> folderNames, HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            List<Folder> existFolderList = folderRepository.findAllByUserAndNameIn(user, folderNames); //findAllByUserAndNameIn 'in'의미 찾기
